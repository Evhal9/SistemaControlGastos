...
const ingresos = [
  ...
  return (
    <>
        <div className="w-[100%] m-2 grid  grid-cols-1  border rounded-xl bg-[#f7d6e8]">
            <div className="flex w-[100%] flex-row p-3">
                ...
                <h3 className="font-bold w-[15%] text-left ">Cantidad</h3>
            </div>
            
            {ingresos.map((ingreso) => (

                <div className="flex w-[100%] flex-row p-2 border-1 border-white hover:bg-[#f29bc1] ">
                    ...
                    <p className="w-[15%]  text-green">${ingreso.monto}</p>
